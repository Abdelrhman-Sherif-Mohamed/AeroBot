...
{
    public static bool IsActive => (Kernel.Bot?.Botbase.Name == "AeroBot.Trade" || Kernel.Bot?.Botbase.Name == "SonicBot.Trade") && Kernel.Bot.Running;
    public string Name => "AeroBot.Trade";
