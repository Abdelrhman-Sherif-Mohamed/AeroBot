...
{
    private static readonly string _name = "AeroBot.Alchemy";

    public static bool IsActive => Kernel.Bot.Running && (Kernel.Bot.Botbase.Name == _name || Kernel.Bot.Botbase.Name == "SonicBot.Alchemy");
