...
public class ClientManager
{
    ...
    /// <summary>
    ///     Gets the client window handle (used by the in-game overlay to follow the game window).
    /// </summary>
    public static IntPtr ClientWindowHandle
    {
        get
        {
            try
            {
                ...
                // MainWindowHandle can be Zero right after start, refresh it
                _process.Refresh();
    ...
    /// <summary>
    ///     Gets the client process id, 0 when not running.
    /// </summary>
